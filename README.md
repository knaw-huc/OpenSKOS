...
docker-compose up 
docker exec openskos-php-fpm /bin/sh /init-openskos.sh
...
```sh
docker-compose up
docker exec openskos-php-fpm composer install
docker exec openskos-php-fpm ./vendor/bin/phing install.dev
```
